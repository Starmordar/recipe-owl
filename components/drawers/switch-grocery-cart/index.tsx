...
interface SwitchGroceryCartDrawerProps extends PropsWithChildren {
  userId: string;
  carts: Array<CartWithUser>;
}

function SwitchGroceryCartDrawer({ userId, carts, children }: SwitchGroceryCartDrawerProps) {
  return (
    <Drawer>
...
export default SwitchGroceryCartDrawer;
